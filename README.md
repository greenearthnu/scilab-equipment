...
- 🔔 **Push Notification** — แจ้งเตือนเมื่ออนุมัติ/ปฏิเสธคำขอจอง/คำขอคืน/ขยายเวลา
- 📧 **Email แจ้งเตือน** — SMTP ส่งอีเมลเมื่อมีคำขอจองใหม่/อนุมัติ/ปฏิเสธคำขอจอง/คำขอคืน/ขยายเวลา
...
| ผู้ดูแลห้องแล็บ (LAB_ADMIN) | เพิ่ม/แก้ไขเครื่องมือ + รูปอุปกรณ์, กำหนดสถานะ, อนุมัติ/ปฏิเสธคำขอจองและคำขอคืน/ขยายเวลา, จัดการผู้ใช้ (บทบาท/สถานะ/รหัสผ่าน), ดูรูปหลักฐาน |
