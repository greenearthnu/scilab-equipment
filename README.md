...
- 📅 **จองเครื่องมือแบบหลายคาบ** — เลือกคาบเรียนได้หลายคาบ/การจอง (ทั้ง web และ mobile) + หน้า web โชว์คาบที่ถูกจองแล้วแบบ real-time
...
- 📊 **แดชบอร์ด/รายงาน** — สถิติการใช้งาน, กราฟ (สถานะ/แนวโน้ม/เครื่องมือยอดนิยม/คาบเรียน), export CSV
...
| บทบาท | สิทธิ์หลัก |
|---|---|
| นักเรียน (STUDENT) | ดูเครื่องมือ, จองหลายคาบ, อัปโหลดรูปหลักฐานหลังใช้, ยกเลิกการจองของตัวเอง |
...
- [x] M9 จองหลายคาบเรียน (Booking → BookingSlot, เลือกได้หลายคาบ/ครั้ง)
...
- [x] M14 สถิติกราฟบนแดชบอร์ด (สถานะการจอง, แนวโน้ม 14 วัน, เครื่องมือยอดนิยม, คาบเรียน) — แสดงสำหรับครู/แอดมิน/ผู้บริหาร
- [x] M15 UX ปรับปรุง — หน้า booking โชว์คาบที่ถูกจองแล้วแบบ real-time, confirm dialog ก่อนยกเลิก/ปฏิเสธ/เช็คเอาท์
