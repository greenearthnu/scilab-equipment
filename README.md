...
- 📆 **มุมมองปฏิทิน** — ดูการจองรายเดือน/ช่วงวันที่, กรองตามเครื่องมือและสถานะ (web)
- 🔄 **ขอคืน/ขยายเวลาการจอง** — ผู้จองส่งคำขอคืนก่อนเวลา / ขยายเวลา → แอดมินอนุมัติ, สถานะและเวลาอัปเดตอัตโนมัติ
- 🕘 **ประวัติการจองส่วนตัว** — กรอง/ค้นหา และ export CSV ประวัติของตัวเอง
